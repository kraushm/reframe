    ...
    site_configuration = {
        ...
        'environments': {
            'kesch': {
                ...
                'PrgEnv-c2sm-gnu': {
                    'type': 'ProgEnvironment',
                    'modules': ['PrgEnv-gnu', '/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/gnu-env/base'],
                    'cc': '${CC}',
                    'cxx': '${CXX}',
                    'ftn': '${FC}',
                },
                'PrgEnv-c2sm-gnu-gpu': {
                    'type': 'ProgEnvironment',
                    'modules': ['PrgEnv-gnu', '/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/gnu-env/gpu'],
                    'cc': '${CC}',
                    'cxx': '${CXX}',
                    'ftn': '${FC}',
                },
                'PrgEnv-c2sm-gnu-cpp': {
                    'type': 'ProgEnvironment',
                    'modules': ['PrgEnv-gnu', '/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/gnu_for_cpp'],
                    'cc': '${CC}',
                    'cxx': '${CXX}',
                    'ftn': '${FC}',
                },
                'PrgEnv-c2sm-cray': {
                    'type': 'ProgEnvironment',
                    'modules': ['PrgEnv-cray', '/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/cray-env/base'],
                    'cc': "${CC}",
                    'cxx': '${CXX}',
                    'ftn': '${FC}',
                },
                'PrgEnv-c2sm-cray-gpu': {
                    'type': 'ProgEnvironment',
                    'modules': ['PrgEnv-cray', '/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/cray-env/gpu'],
                    'cc': "${CC}",
                    'cxx': '${CXX}',
                    'ftn': '${FC}',
                },
                'PrgEnv-c2sm-pgi': {
                    'type': 'ProgEnvironment',
                    'modules': ['/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/pgi-env/base'],
                    'cc': '${CC}',
                    'cxx': '${CXX}',
                    'ftn': '${FC}',
                },
                'PrgEnv-c2sm-pgi-gpu': {
                    'type': 'ProgEnvironment',
                    'modules': ['/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/pgi-env/gpu'],
                    'cc': '${CC}',
                    'cxx': '${CXX}',
                    'ftn': '${FC}',
                },
