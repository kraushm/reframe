    ...
    site_configuration = {
        ...
        'environments': {
            'kesch': {
                ...
                'PrgEnv-c2sm-gnu': {
                    'type': 'ProgEnvironment',
                    'modules': ['/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/gnu-env/base'],
                    'cc': 'mpicc',
                    'cxx': 'mpicxx',
                    'ftn': 'mpif90',
                },
                'PrgEnv-c2sm-gnu-gpu': {
                    'type': 'ProgEnvironment',
                    'modules': ['/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/gnu-env/gpu'],
                    'cc': 'mpicc',
                    'cxx': 'mpicxx',
                    'ftn': 'mpif90',
                },
                'PrgEnv-c2sm-gnu-cpp': {
                    'type': 'ProgEnvironment',
                    'modules': ['/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/gnu_for_cpp'],
                    'cc': 'mpicc',
                    'cxx': 'mpicxx',
                    'ftn': 'mpif90',
                },
                'PrgEnv-c2sm-cray': {
                    'type': 'ProgEnvironment',
                    'modules': ['/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/cray-env/base'],
                    'cc': 'mpicc',
                    'cxx': 'mpicxx',
                    'ftn': 'mpif90',
                },
                'PrgEnv-c2sm-cray-gpu': {
                    'type': 'ProgEnvironment',
                    'modules': ['/users/kraushm/MCH/c2sm-rcm-env/env', 'c2sm/cray-env/gpu'],
                    'cc': 'mpicc',
                    'cxx': 'mpicxx',
                    'ftn': 'mpif90',
                },
